...
const Navigation: React.FC<NavigationProps> = () => {
  ...
  return (
    <nav className='sticky top-0 z-10 bg-gradient-to-l from-[#54151c] to-[#121212]'>
          ...
          <div className='flex'>
            ...
            <div className='hidden sm:ml-6 sm:flex sm:space-x-8'>
              <div className='text- group  relative inline-flex items-center px-1 pt-1 font-medium text-gray-300 hover:text-white'>
                ...
                <ul className='absolute left-[-2px] top-[38px] hidden w-[240px] divide-y divide-[#242424] rounded-sm bg-[#3e3e3e]   group-hover:block'>
