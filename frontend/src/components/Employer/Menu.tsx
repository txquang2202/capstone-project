...
const data = [
  { link: routes.employerDashboard.path, label: 'Dashboard', icon: IconHome },
  { link: routes.employerJobList.path, label: 'Job list', icon: IconList },
  { link: routes.appliedManagement.path, label: 'Ứng viên', icon: IconAward },
  ...
  return (
    <nav className='bg-gradient-search flex h-auto min-w-[250px] flex-col gap-4 pt-4 text-white'>
      <div className='sticky top-4 flex flex-col'>
        <Button
          href={routes.employerAddJob.path}
