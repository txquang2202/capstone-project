const EmployerDifference = () => {
  return (
    <section className='itviec-different-container px-5 pt-[120px]'>
      ...
      <div className='content-wrapper flex items-center justify-center px-5 pb-[120px] pt-[88px]'>
        <div className='content-box relative  mt-4 flex flex-col items-center justify-center rounded-lg bg-white'>
        ...
        <div className='content-box relative mx-7 mt-4 flex flex-col items-center justify-center rounded-lg bg-white'>
