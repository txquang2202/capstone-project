  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='mt-2 flex flex-row items-center gap-2'>
        ...
        />
        <div>
          <p className='text-xl font-bold'>{infor.name}</p>
          <p className='italic'>{infor.role}</p>
        </div>
      </div>
      <div className='mt-2 text-sm'>
        <p className=''>
          {infor.description}{' '}
          <Link href={infor.url} className='text-blue font-semibold'>
            ...xem&nbsp;thêm
          </Link>
        </p>
      </div>
...
const infor = {
  ...
  imageUrl:
    'https://itviec.com/blog/wp-content/uploads/2022/10/tuong-uyen-profile-picture-200x198.jpg',
  description:
