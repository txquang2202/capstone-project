  ...
  return (
    ...
    >
      ...
      <div className='paragraph text-break pt-[16px]'>
        ...
        <p>
          As Australia’s largest business bank, NAB is focused on delivering
          great experiences for customers. To do this it uses modern
          technologies, alongside great technology talent including leading
          software engineers, cloud experts and quality engineers.
        </p>
        <p>
          <strong>
            We’re working on interesting projects to help NAB’s 8 million
            customers:
          </strong>
          By joining us, local software engineers will have access to a wide
          variety of projects and opportunities, working closely with colleagues
          in Australia and with global partners such as AWS and Microsoft to
          take advantage of the latest modern technologies.
        </p>
        <p>
          <strong>We’re investing in you:</strong> We strive&nbsp;to create not
          only a great place to work, but also the best technology centre for
          tech engineers to thrive.
        </p>
        <p>
      ...
      <div className='paragraph border-top-dashed mt-[16px] flex flex-col md:flex-row'>
        <div className='flex cursor-pointer items-center pr-[16px] pt-[16px]'>
          ...
          <div className='hyperlink pl-[4px]'>Company website</div>
        </div>
        <div className='flex cursor-pointer items-center pr-[16px] pt-[16px]'>
          <IconFacebook width={20} height={20} color='#0e2eed' />
          <div className='hyperlink pl-[4px]'>Fanpage Facebook</div>
        </div>
      </div>
    </div>
  );
