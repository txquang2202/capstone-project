...
const AdminCompanyGeneralInformation = ({ company }: Props) => {
  return (
    <div
    ...
    >
      ...
      <div className='mx-0 flex flex-wrap md:pt-[16px]'>
        ...
        <div className='flex w-full flex-auto justify-between py-[8px] md:w-4/12 md:flex-col md:py-[0px]'>
          ...
          <div className='weight-[400] text-[16px]'>{company.company_size}</div>
        </div>
...
export default AdminCompanyGeneralInformation;
