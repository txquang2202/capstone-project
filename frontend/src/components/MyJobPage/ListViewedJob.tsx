...
export default function ListViewedJob() {
...
const optionsEn = ['Most recent viewed', 'About to expire', 'Lasted posting'];
const optionsVi = ['Xem gần nhất', 'Sắp hết hạn', 'Đăng mới nhất'];
const jobs = [
  {
    postedAgo: 34,
