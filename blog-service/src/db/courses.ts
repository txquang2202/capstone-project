export default [
    ...
    },
    {
        ...
        'url': 'https://www.youtube.com/playlist?list=PLSpJkDDmpFZ5rZ5-Aur9WRNsBDSUS-0B9',
        'longDescription': '',
        'iconUrl': 'https://i.ytimg.com/vi/1XmwszKUNR8/hqdefault.jpg?sqp=-oaymwEXCNACELwBSFryq4qpAwkIARUAAIhCGAE=&rs=AOn4CLDQALHVDjwC3xI5dP4Qfh4tlB6Gpg',
        'seqNo': 2,
        'tags': 'INTERMEDIATE',
        'channelTitle': 'CodeWorkr',
        'channelUrl': 'https://www.youtube.com/channel/UCfYTu_qAO5T7a-8rC_74Ypw',
        'channelId': 'UCfYTu_qAO5T7a-8rC_74Ypw',
        'lessons': [
            {
                'seqNo': 1,
                'title': 'Express MongoDB REST API #1 - Introduction',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/1XmwszKUNR8\/default.jpg',
                'description': 'Introductory video where I talk about what to expect in the series to come.',
                'url': 'https://www.youtube.com/watch?v=1XmwszKUNR8',
                'duration': '00:07:48'
            },
            {
                'seqNo': 2,
                'title': 'Express MongoDB REST API #2 - Code Structure',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/C4DjlL2hcrM\/default.jpg',
                'description': "First video where we actually do some work! We start of by writing the main app.js file as well as create a folder structure that we'll keep working on in the videos to come.",
                'url': 'https://www.youtube.com/watch?v=C4DjlL2hcrM',
                'duration': '00:12:26'
            },
            {
                'seqNo': 3,
                'title': 'Express MongoDB REST API #3 - Routes Design',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/_lfDai47SJE\/default.jpg',
                'description': "In this video we'll setup the code for the routes and will get started writing our first route!",
                'url': 'https://www.youtube.com/watch?v=_lfDai47SJE',
                'duration': '00:11:34'
            },
            {
                'seqNo': 4,
                'title': 'Express MongoDB REST API #4 - MongoDB\/Mongoose',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/L1DGbI-U_e4\/default.jpg',
                'description': "In this video, we'll mostly focus on interacting with our MongoDB database using Mongoose.",
                'url': 'https://www.youtube.com/watch?v=L1DGbI-U_e4',
                'duration': '00:29:34'
            },
            {
                'seqNo': 5,
                'title': 'Express MongoDB REST API #5 - Async\/Await',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/9tLA4r-gqds\/default.jpg',
                'description': "In this tutorial, we'll finally start using Async\/Await that'll make our code much nicer to look at!",
                'url': 'https://www.youtube.com/watch?v=9tLA4r-gqds',
                'duration': '00:15:21'
            },
            {
                'seqNo': 6,
                'title': 'Express MongoDB REST API #6 - More Routes',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/qAkzBQw_MrY\/default.jpg',
                'description': "In this video, we'll continue writing more routes as per our original endpoints spec.",
                'url': 'https://www.youtube.com/watch?v=qAkzBQw_MrY',
                'duration': '00:15:12'
            },
            {
                'seqNo': 7,
                'title': 'Express MongoDB REST API #7 - Relationships',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/FVn_wj1jLN0\/default.jpg',
                'description': "In this video, we'll wire up the necessary relationships between models in our routes logic.",
                'url': 'https://www.youtube.com/watch?v=FVn_wj1jLN0',
                'duration': '00:22:49'
            },
            {
                'seqNo': 8,
                'title': 'Express MongoDB REST API #8 - Parameters Validation',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/tJlmAAxwygc\/default.jpg',
                'description': "In this video, we'll set up the validation in our API. We won't just do it, but instead we'll create a function that'll allow us to validate any parameter we would need in future!",
                'url': 'https://www.youtube.com/watch?v=tJlmAAxwygc',
                'duration': '00:30:59'
            },
            {
                'seqNo': 9,
                'title': 'Express MongoDB REST API #9 - Body Validation',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/36v09ARHshc\/default.jpg',
                'description': "In this video, we'll continue where we left off. More precisely, we'll do the body validation this time and also use both the parameters and body validation functions that we wrote throughout our endpoints.",
                'url': 'https://www.youtube.com/watch?v=36v09ARHshc',
                'duration': '00:24:46'
            },
            {
                'seqNo': 10,
                'title': 'Express MongoDB REST API #10 - Cars Routes Start',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/-bQbI2rcoWI\/default.jpg',
                'description': "In this video, we'll begin our work on Cars resource. We'll start by defining routes and writing corresponding code in Cars controller. We'll also do the validation as we go.\n\nAt around ~17 minute mark my microphone started acting weirdly, so sorry for that. Had no idea about it until the video was finished.",
                'url': 'https://www.youtube.com/watch?v=-bQbI2rcoWI',
                'duration': '00:22:29'
            },
            {
                'seqNo': 11,
                'title': 'Express MongoDB REST API #11 - Cars Routes End',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/sA5yM3TALA4\/default.jpg',
                'description': "In this video, we'll finish our work on cars resource. We'll continue by defining routes until we're done. We'll also do the validation as we go.",
                'url': 'https://www.youtube.com/watch?v=sA5yM3TALA4',
                'duration': '00:22:37'
            },
            {
                'seqNo': 12,
                'title': 'Express MongoDB REST API #12 - What to do next',
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/4A-Z7ts7dVg\/default.jpg',
                'description': 'In this video, we finish this playlist and I talk a bit about security and what to do next.',
                'url': 'https://www.youtube.com/watch?v=4A-Z7ts7dVg',
                'duration': '00:03:54'
            }
        ]
    },
    {
        ...
        'url': 'https://www.youtube.com/playlist?list=PLqrUy7kON1meuCvGp2D6yTglZhPTT_s_f',
        'longDescription': '',
        'iconUrl': 'https://i.ytimg.com/vi/XskMWBXNbp0/hqdefault.jpg?sqp=-oaymwEXCNACELwBSFryq4qpAwkIARUAAIhCGAE=&rs=AOn4CLCqe_0mn_r8odSitIcg8ManucWeQg',
        'seqNo': 3,
        'tags': 'INTERMEDIATE',
        'channelTitle': 'Tyler McGinnis',
        'channelUrl': 'https://www.youtube.com/channel/UCbAn7pVK2VIyo-UysfWGdZQ',
        'channelId': 'UCbAn7pVK2VIyo-UysfWGdZQ',
        'lessons': [
            {
                'seqNo': 1,
                'title': "A Beginner's Guide to JavaScript's Prototype",
                'thumbnailUrl': 'https:\/\/i.ytimg.com\/vi\/XskMWBXNbp0\/default.jpg',
